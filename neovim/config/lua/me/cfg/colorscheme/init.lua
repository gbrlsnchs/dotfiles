...
local diagnostics_hl = {
	...
	DiagnosticUnderlineWarn = { bg = palette.black, fg = commons.diagnostic.warn, sp = commons.diagnostic.warn,
		undercurl = true },
	...
	DiagnosticUnderlineError = { bg = palette.black, fg = commons.diagnostic.error, undercurl = true,
	...
	DiagnosticUnderlineInfo = { bg = palette.black, fg = commons.diagnostic.info, undercurl = true,
	...
	DiagnosticUnderlineHint = { bg = palette.black, fg = commons.diagnostic.hint, undercurl = true,
